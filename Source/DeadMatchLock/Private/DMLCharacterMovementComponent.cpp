...
const FDMLCharacterGroundInfo& UDMLCharacterMovementComponent::GetGroundInfo()
{
	...
	else
	{
		...
		const FVector TraceEnd(TraceStart.X, TraceStart.Y, (TraceStart.Z - DMLCharacter::GroundTraceDistance - CapsuleHalfHeight));
		...
		CachedGroundInfo.GroundDistance = DMLCharacter::GroundTraceDistance;
